...
proc draw_image_rotated*(dst: uint8, src: uint8, posX: cint, posY: cint, rotation: cfloat){.importc, cdecl.}
proc draw_image_rotated*(src: uint8, posX: int, posY: int, rotation: float) =
  draw_image_rotated(uint8 0, src, cint posX, cint posY, float rotation)
