...
type
  ...
  retro_video_refresh_t* = proc(data:pointer, width:cuint, height:cuint, pitch:csize_t):void {.cdecl.}
  ...
  retro_audio_sample_batch_t* = proc(data:pointer, frames:csize_t):csize_t {.cdecl.} # 48000/60
